    ...
    public void movePiece() throws IOException {
        ...
        if (cBoard[fromX][fromY] == null) {
                ...
                if (cBoard[toX][toY] == null && ((Pawn) cBoard[fromX][fromY]).validNKMove(fromX, fromY, toX, toY) && Math.abs(toY - fromY) == 0) {
                    if (isObstacleAt(fromX, fromY, toX, toY)) {
                        ...
                        if (pieceFrom.getPiece().substring(1, 2).equals("B")) {
                            if (toX + 1 <= 7 && toX - 1 >= 0 && toY + 1 <= 7 && toY - 1 >= 0 && cBoard[toY + 1][toX - 1].getPiece().equals("WK")) {
                               ((King)cBoard[toY + 1][toX - 1]).setCheck(true);
                            }
                            else if (toX + 1 <= 7 && toX - 1 >= 0 && toY + 1 <= 7 && toY - 1 >= 0 && cBoard[toY - 1][toX - 1].getPiece().equals("WK")) {
                               ((King)cBoard[toY - 1][toX - 1]).setCheck(true);
                            }
                        }
                        if(pieceFrom.getPiece().substring(1, 2).equals("W")){
                            if (toX + 1 <= 7 && toX - 1 >= 0 && toY + 1 <= 7 && toY - 1 >= 0 && cBoard[toY + 1][toX + 1].getPiece().equals("BK")) {
                               ((King)cBoard[toY + 1][toX - 1]).setCheck(true);
                            }
                            else if (toX + 1 <= 7 && toX - 1 >= 0 && toY + 1 <= 7 && toY - 1 >= 0 && cBoard[toY - 1][toX + 1].getPiece().equals("BK")) {
                               ((King)cBoard[toY - 1][toX - 1]).setCheck(true);
                            }
                        }
                    } else {
            ...
            //King
                ...
                if(cBoard[toX][toY].getPiece().substring(1, 2).equals("B")){
                    if(toX + 1 <= 7 && cBoard[toX+1][toY].getPiece().equals("WK")){
                        cBoard[toX+1][toY].setCheck(true);
                    }
                    else if(toX - 1 >= 0 && cBoard[toX+1][toY].getPiece().equals("WK")){
                        cBoard[toX-1][toY].setCheck(true);
                    }
                    else if(toY + 1 <= 7 && cBoard[toX][toY+1].getPiece().equals("WK")){
                        cBoard[toX][toY+1].setCheck(true);
                    }
                    else if(toY - 1 >= 0 && cBoard[toX][toY-1].getPiece().equals("WK")){
                        cBoard[toX][toY-1].setCheck(true);
                    }
                    else if(toX + 1 <= 7 && toY + 1 <= 7 && cBoard[toX+1][toY+1].getPiece().equals("WK")){
                        cBoard[toX+1][toY+1].setCheck(true);
                    } 
                    else if(toX - 1 >= 0 && toY - 1 >= 0 && cBoard[toX-1][toY-1].getPiece().equals("WK")){
                        cBoard[toX-1][toY-1].setCheck(true);
                    }
                    else if(toX + 1 <= 7 && toY - 1 >= 0 && cBoard[toX+1][toY-1].getPiece().equals("WK")){
                        cBoard[toX+1][toY-1].setCheck(true);
                    }
                    else if(toX - 1 >= 0 && toY + 1 <= 7 && cBoard[toX-1][toY+1].getPiece().equals("WK")){
                        cBoard[toX-1][toY+1].setCheck(true);
                    }
                }
                else if(cBoard[toX][toY].getPiece().substring(1, 2).equals("W")){
                    if(toX + 1 <= 7 && cBoard[toX+1][toY].getPiece().equals("BK")){
                        cBoard[toX+1][toY].setCheck(true);
                    }
                    else if(toX - 1 >= 0 && cBoard[toX+1][toY].getPiece().equals("BK")){
                        cBoard[toX-1][toY].setCheck(true);
                    }
                    else if(toY + 1 <= 7 && cBoard[toX][toY+1].getPiece().equals("BK")){
                        cBoard[toX][toY+1].setCheck(true);
                    }
                    else if(toY - 1 >= 0 && cBoard[toX][toY-1].getPiece().equals("BK")){
                        cBoard[toX][toY-1].setCheck(true);
                    }
                    else if(toX + 1 <= 7 && toY + 1 <= 7 && cBoard[toX+1][toY+1].getPiece().equals("BK")){
                        cBoard[toX+1][toY+1].setCheck(true);
                    } 
                    else if(toX - 1 >= 0 && toY - 1 >= 0 && cBoard[toX-1][toY-1].getPiece().equals("BK")){
                        cBoard[toX-1][toY-1].setCheck(true);
                    }
                    else if(toX + 1 <= 7 && toY - 1 >= 0 && cBoard[toX+1][toY-1].getPiece().equals("BK")){
                        cBoard[toX+1][toY-1].setCheck(true);
                    }
                    else if(toX - 1 >= 0 && toY + 1 <= 7 && cBoard[toX-1][toY+1].getPiece().equals("BK")){
                        cBoard[toX-1][toY+1].setCheck(true);
                    }
                }
            } 
            ...
            //Queen
            else if(pieceFrom.getPiece().substring(1, 2).equals("Q")){
                if(((Queen)cBoard[fromX][fromY]).validMove(fromX, fromY, toX, toY)){
                    validMove = true;
                }
            }
...
class King extends ChessPiece {
    ...
    public void setCheck(boolean check) {
        this.check = check;
        System.out.println(getPiece()+" in check.");
    }
}
